...
secrets:
  datas:
    ...
    INTERNAL_FLO_MOEN_AUTH_URL: "${INTERNAL_FLO_MOEN_AUTH_URL}"
    ...
    RESOURCE_EVENT_API_URL: "${RESOURCE_EVENT_API_URL}"
    ...
    DEFAULT_NOTIFY_ACCOUNT_STATUS_EMAIL: "${DEFAULT_NOTIFY_ACCOUNT_STATUS_EMAIL}"
    FLO_ENTERPRISE_SERVICE_URL: "${FLO_ENTERPRISE_SERVICE_URL}"
    CALLBACK_GATEWAY_HOST: "${CALLBACK_GATEWAY_HOST}"
internalIngress:
